...
<div style="font-size:10px;font-family: 黑体;">
 单位：<!-- 四川省成都市公安局温江区分局 -->${(case.organizerName)!}
</div>
...
<tr style="width:100%;height:100px;font-size:18px;font-family: 黑体;height:22px"><td style="width:20%">案件编号</td>
<td colspan="3"></td>
</tr>
...
<tr style="font-size:18px;font-family: 黑体;width:100%;height:22px; ">
<td style="width:20%;">预计归还时间</td>
<td colspan="3"> </td>
</tr>
<tr style="font-size:18px;font-family: 黑体;width:100%;height:22px; ">
<td style="width:20%;">办案人员<br>（签字）</td>
<td style="width:30%;"> </td>
<td style="width:20%;">时间</td>
<td style="width:30%;"> </td>
</tr>
<tr style="font-size:18px;font-family: 黑体;width:100%;height:22px; ">
<td style="width:20%;">库管员<br>（签字）</td>
<td style="width:30%;"> </td>
...
<tr style="font-size:18px;font-family: 黑体;width:100%;height:22px; ">
<td style="width:20%;">审批人<br>（签字）</td>
<td style="width:30%;"> </td>
...
<div style="font-size:10px;font-family: 黑体;">
注：本表一式两份，办案单位保存一份，涉案财物保管中心留一份存档。
</div>
</div>
