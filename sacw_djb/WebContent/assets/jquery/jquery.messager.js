...
+this.layer.width+'px;height:'+this.layer.height+'px;position:absolute; display:none;background:white; bottom:0; right:0; overflow:hidden;"><div style="border:1px solid #ddd;border-bottom:none;width:100%;height:25px;font-size:12px;overflow:hidden;color:#ff0084;"><div style="padding:5px 0 5px 5px;width:100px;line-height:18px;text-align:left;overflow:hidden;">'
